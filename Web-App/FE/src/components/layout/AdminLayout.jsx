...
const AdminLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/admin/coupons', label: 'Mã Giảm Giá', icon: 'M15 5v2a2 2 0 00-2 2 2 2 0 00-2-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2h-2a2 2 0 00-2 2z' },
    ...
    { path: '/admin/security', label: 'An Ninh', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
  ];
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                key={item.path}
                to={item.path}
                className={`flex items-center gap-3 px-4 py-3 mb-2 rounded transition-colors ${isActive
